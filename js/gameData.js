...
export const upgrades = [
  ...
  { 
    ...
    max_level: 12, cost_multiplier: 5,
  ...
  // === Building Boosts ===
  { name: "Efficient Grandmas", cost: 1000, effect: "Grandmas produce 65% more", type: "buildingBoost", target: "Grandma", multiplier: 1.65, max_level: 6, cost_multiplier: 4,
    prestige_bonus_levels: 1, prestige_cost_multiplier: 15,
    requires: [{ type: "building", name: "Grandma", min: 10 }] },
  { name: "Farm Expansion", cost: 10000, effect: "Farms produce 65% more", type: "buildingBoost", target: "Farm", multiplier: 1.65, max_level: 6, cost_multiplier: 4,
    prestige_bonus_levels: 1, prestige_cost_multiplier: 15,
    requires: [{ type: "building", name: "Farm", min: 10 }] },
  { name: "Factory Overdrive", cost: 150000, effect: "Factories are 2x as efficient", type: "buildingBoost", target: "Factory", multiplier: 2, max_level: 6, cost_multiplier: 6,
    prestige_bonus_levels: 1, prestige_cost_multiplier: 20,
    requires: [{ type: "building", name: "Factory", min: 15 }] },
  { name: "Mine Boost", cost: 1500000, effect: "Mines produce 2x as much", type: "buildingBoost", target: "Mine", multiplier: 2, max_level: 5, cost_multiplier: 5,
    prestige_bonus_levels: 1, prestige_cost_multiplier: 20,
    requires: [{ type: "building", name: "Mine", min: 15 }] },
  { name: "Shipment Upgrade", cost: 15000000, effect: "Shipments are 2x as efficient", type: "buildingBoost", target: "Shipment", multiplier: 2, max_level: 5, cost_multiplier: 5,
    prestige_bonus_levels: 1, prestige_cost_multiplier: 20,
    requires: [{ type: "building", name: "Shipment", min: 15 }] },
  { name: "Alchemy Lab Boost", cost: 200000000, effect: "Alchemy Labs produce 2x as much", type: "buildingBoost", target: "Alchemy Lab", multiplier: 2, max_level: 4, cost_multiplier: 8,
  ...
  { name: "Portal Boost", cost: 3000000000, effect: "Portals are 2x as efficient", type: "buildingBoost", target: "Portal", multiplier: 2, max_level: 4, cost_multiplier: 8,
    prestige_bonus_levels: 1, prestige_cost_multiplier: 25,
    requires: [{ type: "building", name: "Portal", min: 15 }, { type: "totalBuildings", min: 150 }] },
  { name: "Time Warp", cost: 50000000000, effect: "Time Machines are 2x as efficient", type: "buildingBoost", target: "Time Machine", multiplier: 2, max_level: 4, cost_multiplier: 10,
  ...
  { name: "Antimatter Boost", cost: 500000000000, effect: "Antimatter Condensers produce 2x", type: "buildingBoost", target: "Antimatter Condenser", multiplier: 2, max_level: 4, cost_multiplier: 10,
    prestige_bonus_levels: 1, prestige_cost_multiplier: 30,
    requires: [{ type: "building", name: "Antimatter Condenser", min: 15 }, { type: "totalBuildings", min: 325 }] },
  { name: "Prism Enhancement", cost: 8000000000000, effect: "Prisms are 2x as efficient", type: "buildingBoost", target: "Prism", multiplier: 2, max_level: 4, cost_multiplier: 12,
    prestige_bonus_levels: 1, prestige_cost_multiplier: 35,
    requires: [{ type: "building", name: "Prism", min: 15 }, { type: "totalBuildings", min: 450 }] },
  { name: "Lucky Day", cost: 150000000000000, effect: "Chancemakers produce 2x", type: "buildingBoost", target: "Chancemaker", multiplier: 2, max_level: 4, cost_multiplier: 12,
    prestige_bonus_levels: 1, prestige_cost_multiplier: 35,
    requires: [{ type: "building", name: "Chancemaker", min: 15 }, { type: "totalBuildings", min: 600 }] },
  { name: "Fractal Boost", cost: 2500000000000000, effect: "Fractal Engines produce 2x", type: "buildingBoost", target: "Fractal Engine", multiplier: 2, max_level: 4, cost_multiplier: 15,
  ...
  { name: "Cookie Recipe", cost: 500000, effect: "All production +10%", type: "globalCpsMultiplier", multiplier: 1.10, max_level: 6, cost_multiplier: 12,
    prestige_bonus_levels: 1, prestige_cost_multiplier: 25,
    requires: [{ type: "cps", min: 200 }, { type: "totalBuildings", min: 30 }] },
  { name: "Industrial Revolution", cost: 100000000, effect: "All production +25%", type: "globalCpsMultiplier", multiplier: 1.25, max_level: 4, cost_multiplier: 20,
    prestige_bonus_levels: 1, prestige_cost_multiplier: 40,
    requires: [{ type: "cps", min: 50000 }, { type: "totalBuildings", min: 150 }] },
  { name: "Cookie Singularity", cost: 100000000000, effect: "All production +50%", type: "globalCpsMultiplier", multiplier: 1.50, max_level: 3, cost_multiplier: 100,
  ...
  { name: "Grandma's Farmhands", cost: 100000, effect: "Each Grandma adds +0.5 CPS to Farms", type: "synergy", source: "Grandma", target: "Farm", bonus: 0.5, max_level: 5, cost_multiplier: 8,
    prestige_bonus_levels: 1, prestige_cost_multiplier: 20,
    requires: [{ type: "building", name: "Grandma", min: 15 }, { type: "building", name: "Farm", min: 15 }] },
  { name: "Factory Automation", cost: 5000000, effect: "Each Factory adds +2 CPS to Mines", type: "synergy", source: "Factory", target: "Mine", bonus: 2, max_level: 5, cost_multiplier: 8,
    prestige_bonus_levels: 1, prestige_cost_multiplier: 20,
    requires: [{ type: "building", name: "Factory", min: 20 }, { type: "building", name: "Mine", min: 15 }] },
  { name: "Portal Network", cost: 5000000000, effect: "Each Portal adds +50 CPS to Shipments", type: "synergy", source: "Portal", target: "Shipment", bonus: 50, max_level: 5, cost_multiplier: 10,
    prestige_bonus_levels: 1, prestige_cost_multiplier: 25,
    requires: [{ type: "building", name: "Portal", min: 15 }, { type: "building", name: "Shipment", min: 20 }] },
  { name: "Temporal Alchemy", cost: 100000000000, effect: "Each Time Machine adds +200 CPS to Alchemy Labs", type: "synergy", source: "Time Machine", target: "Alchemy Lab", bonus: 200, max_level: 5, cost_multiplier: 10,
    prestige_bonus_levels: 1, prestige_cost_multiplier: 25,
    requires: [{ type: "building", name: "Time Machine", min: 15 }, { type: "building", name: "Alchemy Lab", min: 20 }] },
  { name: "Fractal Prisms", cost: 2000000000000000, effect: "Each Fractal Engine adds +50K CPS to Prisms", type: "synergy", source: "Fractal Engine", target: "Prism", bonus: 50000, max_level: 3, cost_multiplier: 15,
    prestige_bonus_levels: 1, prestige_cost_multiplier: 30,
