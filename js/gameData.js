...
export const heavenlyUpgrades = [
  // Tier 1 — Early Prestige (1-5 HC)
  { id: "heavenlyCookies", name: "Heavenly Cookies", cost: 1,
    desc: "Start each run with 10x more starting cookies (150 instead of 15).",
    effect: "startingCookiesMultiplier", value: 10,
    requires: [] },
  { id: "twinGates", name: "Twin Gates of Transcendence", cost: 2,
    desc: "All buildings are 5% cheaper.",
    effect: "buildingCostReduction", value: 0.05,
    requires: [] },
  { id: "heavenlyLuck", name: "Heavenly Luck", cost: 3,
    desc: "Golden cookies appear 20% more frequently.",
    effect: "goldenCookieFrequency", value: 0.20,
    requires: [] },
  { id: "angels", name: "Angels", cost: 5,
    desc: "+5% base CPS permanently.",
    effect: "baseCpsMultiplier", value: 0.05,
    requires: [] },

  // Tier 2 — Mid Prestige (10-25 HC)
  { id: "starterKit", name: "Starter Kit", cost: 10,
    desc: "Start each run with 1 free Cursor, Grandma, and Farm.",
    effect: "starterBuildings", value: [0, 1, 2],
    requires: ["heavenlyCookies"] },
  { id: "persistentMemory", name: "Persistent Memory", cost: 15,
    desc: "Retain 10% of your upgrade levels after prestige (rounded down).",
    effect: "persistentMemory", value: 0.10,
    requires: ["heavenlyCookies"] },
  { id: "divineDiscount", name: "Divine Discount", cost: 15,
    desc: "All upgrade costs reduced by 5%.",
    effect: "upgradeCostReduction", value: 0.05,
    requires: ["twinGates"] },
  { id: "seasonSavings", name: "Season Savings", cost: 20,
    desc: "+10% CPS per prestige level.",
    effect: "cpsPerPrestige", value: 0.10,
    requires: ["angels"] },
  { id: "divineBakeries", name: "Divine Bakeries", cost: 25,
    desc: "Buildings produce +2% CPS per prestige level.",
    effect: "buildingCpsPerPrestige", value: 0.02,
    requires: ["angels"] },

  // Tier 3 — Deep Prestige (50-200 HC)
  { id: "kittenWorkers", name: "Kitten Workers", cost: 50,
    desc: "+1% CPS per achievement unlocked.",
    effect: "cpsPerAchievement", value: 0.01,
    requires: ["seasonSavings"] },
  { id: "synergyVol2", name: "Synergy Vol. II", cost: 75,
    desc: "All synergy upgrade effects are doubled.",
    effect: "synergyDoubler", value: 2,
    requires: ["divineBakeries"] },
  { id: "cosmicGrandma", name: "Cosmic Grandma", cost: 100,
    desc: "Grandma base CPS multiplied by 10.",
    effect: "grandmaMultiplier", value: 10,
    requires: ["kittenWorkers"] },
  { id: "hcInterest", name: "Heavenly Chips Interest", cost: 100,
    desc: "Gain +0.5% more Heavenly Chips per ascension.",
    effect: "hcInterest", value: 0.005,
    requires: ["kittenWorkers"] },
  { id: "frenzyOverload", name: "Frenzy Overload", cost: 150,
    desc: "Frenzies give 2x their normal multiplier.",
    effect: "frenzyMultiplier", value: 2,
    requires: ["synergyVol2"] },
  { id: "ascendantBakers", name: "Ascendant Bakers", cost: 200,
  ...
  // Tier 4 — Deep Prestige (300-1500 HC)
  { id: "luckyStars", name: "Lucky Stars", cost: 300,
    desc: "Lucky clicks give 3x cookie rewards.",
    effect: "luckyClickMultiplier", value: 3,
    requires: ["ascendantBakers"] },
  { id: "goldenAge", name: "Golden Age", cost: 400,
    desc: "Golden cookies appear 40% more frequently (stacks with Heavenly Luck).",
    effect: "goldenCookieFrequency2", value: 0.40,
    requires: ["ascendantBakers"] },
  { id: "infiniteWisdom", name: "Infinite Wisdom", cost: 500,
    desc: "All upgrade max levels +1.",
    effect: "bonusUpgradeLevels", value: 1,
    requires: ["luckyStars"] },
  { id: "cosmicResonance", name: "Cosmic Resonance", cost: 750,
    desc: "+0.5% CPS per building type owned (16 types = +8% CPS).",
    effect: "cpsPerBuildingType", value: 0.005,
    requires: ["goldenAge"] },
  { id: "eternalDominion", name: "Eternal Dominion", cost: 1000,
    desc: "All building base CPS x2.",
    effect: "allBuildingCpsMultiplier", value: 2,
    requires: ["infiniteWisdom", "cosmicResonance"] },
  { id: "heavenlyClicking", name: "Heavenly Clicking", cost: 500,
    desc: "Clicking power x3.",
    effect: "clickMultiplier", value: 3,
    requires: ["luckyStars"] },
  { id: "divinePersistence", name: "Divine Persistence", cost: 750,
    desc: "Retain 25% of upgrade levels after prestige (up from 10%).",
    effect: "persistentMemory2", value: 0.25,
    requires: ["infiniteWisdom"] },
  { id: "cosmicSynergy", name: "Cosmic Synergy", cost: 1500,
    desc: "All synergy effects x3 (stacks with Synergy Vol. II for x6 total).",
    effect: "synergyTripler", value: 3,
