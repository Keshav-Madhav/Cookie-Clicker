export const buildings = [
  ...
  { name: "Idleverse", cost: 12000000000000000, cps: 2800000000, cost_multiplier: 1.20,
    ...
    desc: "Harvests cookies from idle parallel universes.",
    flavor: "Somewhere out there, a version of you is also clicking cookies. You're stealing theirs now. They don't know yet.",
  ...
  { name: "Cortex Baker", cost: 300000000000000000, cps: 19000000000, cost_multiplier: 1.21,
    ...
    desc: "A giant brain-shaped cookie processor.",
    flavor: "It thinks, therefore it bakes. It tried thinking about something else once. It couldn't.",
  ...
  { name: "Reality Bender", cost: 8000000000000000000, cps: 130000000000, cost_multiplier: 1.22,
    ...
    desc: "Rewrites the laws of physics to produce cookies.",
    flavor: "Gravity now pulls things toward the nearest cookie. The physicists are furious. The cookies are unbothered.",
...
export const upgrades = [
  ...
  { name: "Idleverse Boost", cost: 150000000000000000, effect: "Idleverses produce 2.5x", type: "buildingBoost", target: "Idleverse", multiplier: 2.5, max_level: 8, cost_multiplier: 10,
    accel_start: 5, cost_acceleration: 3,
  ...
  { name: "Cortex Enhancement", cost: 3000000000000000000, effect: "Cortex Bakers produce 3x", type: "buildingBoost", target: "Cortex Baker", multiplier: 3, max_level: 8, cost_multiplier: 12,
    accel_start: 5, cost_acceleration: 3,
    prestige_bonus_levels: 2, prestige_cost_multiplier: 35,
    requires: [{ type: "building", name: "Cortex Baker", min: 15 }, { type: "totalBuildings", min: 800 }] },
  { name: "Reality Warp", cost: 80000000000000000000, effect: "Reality Benders produce 3x", type: "buildingBoost", target: "Reality Bender", multiplier: 3, max_level: 7, cost_multiplier: 15,
  ...
  { name: "Idle Fractals", cost: 20000000000000000, effect: "Each Idleverse adds +5M CPS to Fractal Engines", type: "synergy", source: "Idleverse", target: "Fractal Engine", bonus: 5000000, max_level: 5, cost_multiplier: 15,
    accel_start: 3, cost_acceleration: 3,
    prestige_bonus_levels: 1, prestige_cost_multiplier: 30,
    requires: [{ type: "building", name: "Idleverse", min: 10 }, { type: "building", name: "Fractal Engine", min: 20 }] },
  { name: "Cortex Idleverses", cost: 5000000000000000000, effect: "Each Cortex Baker adds +500M CPS to Idleverses", type: "synergy", source: "Cortex Baker", target: "Idleverse", bonus: 500000000, max_level: 5, cost_multiplier: 18,
    accel_start: 3, cost_acceleration: 3,
  ...
  { name: "Reality Cortex", cost: 100000000000000000000, effect: "Each Reality Bender adds +5B CPS to Cortex Bakers", type: "synergy", source: "Reality Bender", target: "Cortex Baker", bonus: 5000000000, max_level: 5, cost_multiplier: 20,
    accel_start: 3, cost_acceleration: 3,
    prestige_bonus_levels: 1, prestige_cost_multiplier: 40,
    requires: [{ type: "building", name: "Reality Bender", min: 10 }, { type: "building", name: "Cortex Baker", min: 20 }] },
  { name: "Omniversal Baking", cost: 5000000000000000000000, effect: "Each Idleverse adds +100M CPS to Reality Benders", type: "synergy", source: "Idleverse", target: "Reality Bender", bonus: 100000000, max_level: 5, cost_multiplier: 20,
    accel_start: 3, cost_acceleration: 3,
    prestige_bonus_levels: 1, prestige_cost_multiplier: 40,
    requires: [{ type: "building", name: "Idleverse", min: 20 }, { type: "building", name: "Reality Bender", min: 15 }] },
  { name: "Grandma's Reality", cost: 500000000000000000000, effect: "Each Grandma adds +1M CPS to Reality Benders", type: "synergy", source: "Grandma", target: "Reality Bender", bonus: 1000000, max_level: 5, cost_multiplier: 15,
    accel_start: 3, cost_acceleration: 3,
    prestige_bonus_levels: 1, prestige_cost_multiplier: 30,
